    ...
    <section className="relative py-24 lg:py-32 bg-[var(--color-footer-bg)] overflow-hidden font-sans text-white">
      ...
      <div className="container relative z-10 px-4 md:px-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 auto-rows-fr">
          ...
          <div className="md:col-span-2 group relative overflow-hidden rounded-[2.5rem] bg-white/5 border border-white/10 p-8 md:p-12 hover:border-[var(--color-accent)]/30 transition-all duration-500">
             ...
             <div className="relative z-10 h-full flex flex-col justify-between">
               <div className="w-16 h-16 rounded-2xl bg-white/10 flex items-center justify-center text-[var(--color-accent)] mb-6 border border-white/5 backdrop-blur-md shadow-lg">
          ...
          {/* CARD 4: 24h Notfall */}
          <div className="group relative overflow-hidden rounded-[2.5rem] bg-gradient-to-br from-[var(--color-primary)]/80 to-[var(--color-primary)]/40 border border-white/10 p-8 hover:scale-[1.02] transition-all duration-300">
             ...
             <div className="w-14 h-14 rounded-full bg-white/10 flex items-center justify-center text-white mb-6 group-hover:scale-110 transition-transform border border-white/20">
           ...
           <div className="md:col-span-1 relative flex flex-col gap-6">
              ...
              <Link href="/leistungen/betreuung" className="flex-1 rounded-[2.5rem] bg-white/5 border border-white/5 p-8 hover:bg-white/10 hover:border-[var(--color-accent)]/40 transition-all group cursor-pointer">
                <div className="w-12 h-12 rounded-full bg-white/10 flex items-center justify-center text-white mb-4 group-hover:scale-110 transition-transform group-hover:bg-[var(--color-accent)]">
