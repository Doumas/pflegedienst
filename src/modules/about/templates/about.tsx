  ...
  return (
    <div className="min-h-screen bg-white font-sans pb-20 selection:bg-[var(--color-primary)]/20">
      ...
      <section className="py-24 bg-[var(--color-secondary)] relative overflow-hidden">
        ...
        <div className="absolute top-0 right-0 w-[400px] h-[400px] bg-white rounded-full blur-[80px] opacity-60 pointer-events-none translate-x-1/3 -translate-y-1/3" />

        <div className="container text-center px-4 md:px-6 relative z-10">
          
          <div className="bg-white rounded-[3rem] p-10 md:p-16 border border-[var(--color-border-soft)] shadow-2xl shadow-[var(--color-primary)]/5 max-w-5xl mx-auto">
             <div className="inline-flex items-center justify-center w-20 h-20 bg-[var(--color-secondary)] rounded-full text-[var(--color-primary)] mb-8 border border-[var(--color-primary)]/10">
                <MapPin className="w-10 h-10" />
             </div>

             <h2 className="text-3xl md:text-5xl font-black text-slate-900 mb-6 tracking-tight">Unterwegs in Ihrer Nachbarschaft</h2>
             <p className="text-xl text-slate-600 max-w-2xl mx-auto mb-10 font-medium">
               Wir versorgen Patienten im gesamten Stadtgebiet München und Umland. 
               Lassen Sie uns unverbindlich prüfen, ob wir Kapazitäten in Ihrer Straße haben.
             </p>
             
             <div className="flex flex-col sm:flex-row justify-center gap-4">
               <Link href="/kontakt">
                <Button size="lg" className="h-14 px-10 text-lg bg-[var(--color-primary)] hover:bg-[var(--color-primary-hover)] text-white rounded-2xl shadow-xl shadow-[var(--color-primary)]/20 hover:-translate-y-1 transition-all font-bold w-full sm:w-auto">
                  Verfügbarkeit prüfen <ArrowRight className="ml-2 w-5 h-5" />
                </Button>
               </Link>
               
               <Button variant="outline" className="h-14 px-10 text-lg border-2 border-slate-200 text-slate-600 hover:bg-slate-50 hover:text-slate-900 rounded-2xl font-bold w-full sm:w-auto cursor-default">
                  <Phone className="mr-2 w-5 h-5" /> 089 - 123 456 78
               </Button>
             </div>
          </div>
