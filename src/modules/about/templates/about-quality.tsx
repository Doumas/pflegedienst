...
export function AboutQuality() {
  return (
    <section className="py-24 lg:py-32 bg-[var(--color-footer-bg)] text-white relative overflow-hidden font-sans">
      ...
      {/* 1. HINTERGRUND-ANIMATION (Award Icons in Akzentfarbe für edlen Look) */}
      <AnimatedBackground icon={Award} variant="section" color="text-[var(--color-accent)]" />
      
      {/* 2. Textur Overlay für Tiefe */}
        ...
        <div className="grid lg:grid-cols-2 gap-16 lg:gap-24 items-center">
           ...
           <FadeIn direction="right">
            <div className="relative group">
                ...
                {/* Bild Container */}
                <div className="relative aspect-video rounded-[2.5rem] overflow-hidden border-4 border-white/10 shadow-2xl shadow-black/50 bg-black/20">
                    <Image 
              ...
              <FadeIn delay={0.2} direction="left">
                <div>
                    ...
                    <h2 className="text-4xl md:text-5xl lg:text-6xl text-white font-black mb-6 tracking-tight text-balance leading-[1.1]">
                        Kein Zufall, <br/>sondern Standard.
                    </h2>
              ...
              <div className="grid gap-4 w-full">
                 {[
                    ...
                    <FadeIn key={i} delay={0.3 + (i * 0.1)} direction="left">
                        <div className="group flex gap-5 p-5 rounded-2xl bg-white/5 border border-white/5 hover:bg-white/10 hover:border-[var(--color-accent)]/50 transition-all duration-300 text-left relative overflow-hidden">
                            {/* Hover Highlight Effekt */}
                            <div className="absolute inset-0 bg-gradient-to-r from-[var(--color-accent)]/0 via-[var(--color-accent)]/5 to-[var(--color-accent)]/0 translate-x-[-100%] group-hover:translate-x-[100%] transition-transform duration-1000 pointer-events-none" />
                            
                            <div className="shrink-0 w-14 h-14 rounded-full bg-[var(--color-primary)] flex items-center justify-center text-white shadow-lg shadow-black/20 group-hover:scale-110 transition-transform duration-300 border border-white/10">
                            ...
                            <div>
                                ...
                                <div className="text-base text-white/60 group-hover:text-white/80 transition-colors">{fact.desc}</div>
                            </div>
                        </div>
                    </FadeIn>
                 ))}
