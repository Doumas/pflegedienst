...
import { 
  Heart, Award, MapPin, Users, Clock, Quote, ArrowRight, 
...
export function AboutTemplate() {
  ...
  return (
    <>
    {/* HAUPTSEITE: Bekommt Klasse 'hide-on-print', damit sie im Druck verschwindet */}
    <div className="hide-on-print min-h-screen bg-white font-sans pb-20 selection:bg-[var(--color-primary)]/20">
      ...
      <section className="py-24 bg-white relative">
        <div className="container text-center px-4 md:px-6">
          <div className="inline-flex items-center justify-center w-16 h-16 bg-[var(--color-secondary)] rounded-full text-[var(--color-primary)] mb-6 border border-[var(--color-primary)]/10 animate-in zoom-in duration-500"><MapPin className="w-8 h-8" /></div>
          <h2 className="text-3xl md:text-5xl font-black text-slate-900 mb-6 tracking-tight">In Frankfurt für Sie unterwegs</h2>
          ...
          <div className="flex flex-wrap justify-center gap-3 max-w-4xl mx-auto mb-16">
            ...
            <div className="px-6 py-3 text-slate-400 font-medium italic">... und in Ihrer Nähe.</div>
          </div>
          <div className="bg-[var(--color-secondary)] rounded-[2.5rem] p-8 md:p-12 max-w-4xl mx-auto border border-[var(--color-border-soft)] flex flex-col md:flex-row items-center justify-between gap-8 relative overflow-hidden">
             ...
             <Link href="/kontakt" className="relative z-10">
              <Button size="lg" className="bg-[var(--color-primary)] hover:bg-[var(--color-primary-hover)] text-white rounded-2xl px-10 h-14 shadow-xl font-bold text-lg">Jetzt prüfen <ArrowRight className="ml-2 w-5 h-5" /></Button>
            </Link>
          </div>
        </div>
      </section>
    ...
    {/* ========================================================= */}
    {/* 5-SEITEN BROSCHÜRE (MODAL)                                */}
    {/* ========================================================= */}
    {isFlyerOpen && (
      // ID 'print-overlay' ist entscheidend für das CSS
      <div id="print-overlay">
         ...
         <div id="flyer-content-container">
            ...
            {/* ================= SEITE 1: COVER ================= */}
            {/* Hier habe ich 'p-16' direkt in den Content gepackt, nicht in den Container */}
