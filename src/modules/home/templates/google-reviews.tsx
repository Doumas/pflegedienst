    ...
    <section className="py-24 lg:py-32 bg-[var(--color-secondary)] text-slate-900 border-b border-white overflow-hidden relative font-sans">
      ...
      <div className="container px-4 md:px-6 relative z-10">
        ...
        <div className="flex flex-col items-center text-center mb-16 lg:mb-24">
          ...
          >
            <div className="group inline-flex items-center gap-3 bg-white border border-[var(--color-border-soft)] rounded-full pl-1.5 pr-6 py-1.5 shadow-sm mb-8 animate-in fade-in zoom-in duration-700 hover:shadow-lg hover:border-[var(--color-primary)]/30 hover:scale-105 transition-all">
          ...
          <p className="text-slate-600 max-w-2xl text-lg md:text-xl leading-relaxed font-medium animate-in fade-in slide-in-from-bottom-4 duration-700 delay-200">
            ...
            >
              ...
              <div className="relative z-10">
                 <div className="flex items-center justify-between mb-6">
                    ...
                    {/* Verifiziert Icon - Erscheint beim Hover */}
                    <div className="flex items-center gap-1 text-[10px] font-bold text-green-600 bg-green-50 px-2 py-0.5 rounded-full opacity-0 group-hover:opacity-100 transition-opacity duration-300 transform translate-x-2 group-hover:translate-x-0">
        ...
        <div className="flex justify-center animate-in fade-in slide-in-from-bottom-4 duration-700 delay-500">
            <Link href={GOOGLE_REVIEW_LINK} target="_blank" rel="noopener noreferrer">
                {/* WICHTIG: Button als DIV gerendert für korrekte Link-Semantik */}
                <div className={cn(
                    buttonVariants({ variant: "outline", size: "lg" }), 
                    "h-14 px-8 border-white bg-white/50 backdrop-blur-sm hover:bg-white text-slate-600 hover:text-[var(--color-primary)] hover:border-[var(--color-primary)]/20 shadow-sm group cursor-pointer rounded-full font-bold"
                )}>
