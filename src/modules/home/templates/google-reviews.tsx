...
// --- REVIEW CARD (Responsive Alignment) ---
function ReviewCard({ review }: { review: typeof reviews[0] }) {
    ...
    return (
        ...
        >
            {/* Quote Icon - Auf Mobile dezenter/mittig, Desktop rechts */}
            <Quote className={cn(
                "absolute w-10 h-10 fill-current transition-colors duration-500 pointer-events-none",
                // Mobile: Oben Mitte (leicht transparent) / Desktop: Oben Rechts
                "top-4 left-1/2 -translate-x-1/2 lg:left-auto lg:translate-x-0 lg:top-8 lg:right-8",
                isInCenter ? "text-[var(--color-primary)]/10" : "text-slate-50 group-hover:text-[var(--color-primary)]/5"
            )} />
            ...
            <div className="relative z-10 w-full">
                ...
                <div className="flex flex-col lg:flex-row items-center lg:justify-between gap-3 mb-6 w-full">
                    ...
                    {/* Verifiziert Badge */}
                    <div className={cn(
                        "flex items-center gap-1.5 text-[10px] font-bold text-green-600 bg-green-50 px-3 py-1 rounded-full transition-all duration-300",
                        isInCenter 
                            ? "opacity-100" 
      ...
      <div className="container px-4 md:px-6 relative z-10">
        ...
        <div className="flex flex-col items-center lg:items-start text-center lg:text-left mb-16 lg:mb-24">
          ...
          <FadeIn delay={0.1}>
            ...
            >
                <div className="group inline-flex items-center gap-3 bg-white border border-slate-200 rounded-full pl-2 pr-6 py-2 shadow-sm mb-8 hover:shadow-lg hover:border-[var(--color-primary)]/30 hover:scale-105 transition-all">
        ...
        {/* GOOGLE LINK BUTTON - Alignment handled by parent flex */}
