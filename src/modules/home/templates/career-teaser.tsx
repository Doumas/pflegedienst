    ...
    return (
        ...
        >
            ...
            <div className="flex items-center gap-5 mb-8 border-b border-slate-100 pb-6">
                <div className={cn(
                    "w-16 h-16 rounded-2xl bg-gradient-to-br from-[var(--color-primary)] to-[var(--color-accent)] flex items-center justify-center shadow-lg shadow-[var(--color-primary)]/20 shrink-0 transition-transform duration-500",
                    isInCenter ? "scale-110" : "group-hover:scale-110"
                )}>
                    <span className="text-white font-black text-3xl font-serif">D</span>
                </div>
        ...
        <div className="grid lg:grid-cols-2 gap-16 lg:gap-24 items-center">
          ...
          <div className="space-y-8 order-2 lg:order-1 flex flex-col items-center lg:items-start text-center lg:text-left">
           ...
           <FadeIn delay={0.3}>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 py-2 w-full lg:w-auto">
              {[
                ...
                <FadeIn key={i} delay={0.5 + (i * 0.1)} direction="up" className="w-full">
                    {/* Karte: Volle Breite auf Mobile */}
                    <div className="group flex items-center gap-4 bg-white/80 p-4 rounded-2xl border border-white hover:border-[var(--color-primary)]/20 hover:bg-white hover:shadow-lg transition-all shadow-sm transform-gpu w-full">
            ...
            {/* --- BUTTONS & HINWEIS --- */}
            {/* KORREKTUR: items-center auf Mobile zwingt den Text in die Mitte */}
            <div className="pt-8 flex flex-col lg:flex-row gap-6 items-center lg:items-center w-full justify-center lg:justify-start">
               <FadeIn delay={0.9} direction="right">
                   <Link href="/karriere">
                    <div className={cn(
                        ...
                        // w-auto statt w-full -> Button wird nicht mehr langgezogen
                        "w-auto h-14 px-8 text-lg rounded-full shadow-xl shadow-[var(--color-primary)]/20 hover:-translate-y-1 active:scale-95 transition-all cursor-pointer font-bold"
                    )}>
               ...
               {/* KORREKTUR: FadeIn Container ist jetzt auf Mobile w-full und zentriert seinen Inhalt */}
