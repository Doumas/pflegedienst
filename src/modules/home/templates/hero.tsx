        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 lg:gap-20 items-center lg:items-start">
          ...
          <div className="order-1 flex flex-col items-center lg:items-start text-center lg:text-left space-y-4 lg:space-y-8">
           ...
           <FadeIn delay={0.2}>
            ...
            {/* Subtext */}
            <FadeIn delay={0.3}>
                <p className="text-base lg:text-xl text-slate-600 leading-relaxed max-w-lg mx-auto lg:mx-0 font-medium">
          ...
          <div className="order-3 lg:col-start-1 w-full max-w-lg mx-auto lg:mx-0 pt-2 lg:pt-0">
                <FadeIn delay={0.4} className="w-full">
                    <div 
                        ref={widgetRef} 
                        className={cn(
                        "bg-white rounded-[2rem] p-4 xs:p-5 lg:p-6 shadow-xl shadow-slate-200/60 border ring-1 ring-slate-50 relative overflow-hidden transition-all duration-500 group/widget transform-gpu",
