  ...
  return (
    <section className="relative z-30 px-4">
      <div className="container">
        {/* Negativer Margin (-mt-24) zieht die Boxen in den Hero-Bereich hoch */}
          ...
          {links.map((item, i) => (
            <Link key={i} href={item.href} className="group">
              <div className="bg-white p-8 rounded-2xl shadow-xl border border-slate-100 h-full flex flex-col hover:-translate-y-2 transition-all duration-300 relative overflow-hidden">
                ...
                {/* Hover Effekt: Farbiger Balken unten */}
                ...
                <div className="flex items-start justify-between mb-4">
                  <div className="w-12 h-12 bg-secondary rounded-xl flex items-center justify-center text-primary group-hover:bg-primary group-hover:text-white transition-colors">
